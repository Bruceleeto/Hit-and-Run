...
//
// MSPACES uses mmap when the pre-allocated heap size is too small,
...
public radRefCount
{
	...
	{
		void * pMemory = mspace_malloc( m_MallocState, size );
	...
	{
		void * pMemory = mspace_memalign( m_MallocState, alignment, size );
	...
	{
        uintptr_t memory = (uintptr_t) pMemory;
	...
	virtual void FreeMemory( void* pMemory )
	{
		...
		if ( pMemory != NULL )
		{
			mspace_free( m_MallocState, pMemory );
...
//--------------------------------------------------------------------------------------------------
    ...
    uintptr_t m_SizeOfMemory;
	
	mspace m_MallocState;
